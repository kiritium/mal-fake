...
public class AnimeTable extends Panel {
    ...
    protected void onInitialize() {
        ...
        columns.add(new PropertyColumn<AnimeDO, String>(Model.of("Alt. Title"), "altTitle", "altTitle"));
        ...
        add(new SortableTable<AnimeDO, String>("test", columns, dataProvider, 10) {
			...
			@Override
        	protected Item<AnimeDO> newRowItem(final String id, final int index, final IModel<AnimeDO> model)
        	{
